<h1 align="center">👋 Hi, I'm Sa1chemist | Developer</h1>
<p align="center">
  <b>Backend & AI Developer • Python | FastAPI | Flask | SQLAlchemy | Full-Stack | Linux • 2025-2028 Developer Roadmap</b><br>
</p>
...
> *(Public projects where I’ve contributed code, docs, or issues)*
...
**Frameworks:** FastAPI, Flask, SQLAlchemy, React (basic), Bootstrap  
**Databases:** SQLite, MySQL, PostgreSQL (basic)  
**Tools:** Git, Docker, Linux, PowerShell, Nginx, CI/CD  
**ML/AI:** scikit-learn, PyTorch, transformers  
**Other:** REST, OAuth, JWT, JSON, APIs, Cloudflare, VPS deployment  
